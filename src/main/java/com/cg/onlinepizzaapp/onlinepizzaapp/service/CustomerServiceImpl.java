...
public class CustomerServiceImpl implements ICustomerService{
	...
	public Customer addCustomer(Customer customer) {
		...
		Optional<Customer> cust = custRepo.findBycustomerEmail(customer.getCustomerEmail());
		if(cust.isPresent()) {
			throw new CustomerAlreadyPresentException("Customer with mobile number " + customer.getCustomerEmail()+ " is already registered");
		}
		else {
